jQuery(document).ready(function($) {
    ...
    $('.flex-direction-nav a.flex-prev').attr({
        'title': S3WaaSAccessibilityParams.flexNavPrevTitle,
        'aria-label': S3WaaSAccessibilityParams.flexNavPrevTitle
    });
    $('.flex-pauseplay a.flex-pause').attr({
        'title': S3WaaSAccessibilityParams.flexNavPlayPauseTitle,
        'aria-label': S3WaaSAccessibilityParams.flexNavPlayPauseTitle
    });
    $('.flex-direction-nav a.flex-next').attr({
        'title': S3WaaSAccessibilityParams.flexNavNextTitle,
        'aria-label': S3WaaSAccessibilityParams.flexNavNextTitle
    });
